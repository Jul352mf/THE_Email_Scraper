...
- **Scale**: 53 files, 31,482 lines of code
- **Languages**: JSON, Markdown, Python, Unknown
- **Critical Issues**: 0 found
- **Major Issues**: 67 found
...
### 4. Hardcoded API key
**Severity**: Major | **Confidence**: High
**Evidence**: `REVIEW/BRANCH-REVIEW.md:78`
```
config.api_key = "te***"
```
**Impact**: Hardcoded credentials pose security risk
...
### 5. Hardcoded API key
**Severity**: Major | **Confidence**: High
**Evidence**: `REVIEW/BRANCH-REVIEW.md:87`
```
config.api_key = "te***"
```
**Impact**: Hardcoded credentials pose security risk
...
### 6. Hardcoded API key
**Severity**: Major | **Confidence**: High
**Evidence**: `REVIEW/EMAIL-SCRAPER-REVIEW.md:86`
```
config.api_key = "te***"
```
**Impact**: Hardcoded credentials pose security risk
...
### 7. Hardcoded API key
**Severity**: Major | **Confidence**: High
**Evidence**: `REVIEW/EMAIL-SCRAPER-REVIEW.md:95`
```
config.api_key = "te***"
```
**Impact**: Hardcoded credentials pose security risk
...
### 8. Hardcoded API key
**Severity**: Major | **Confidence**: High
**Evidence**: `REVIEW/EMAIL-SCRAPER-REVIEW.md:104`
```
config.api_key = "te***"
```
**Impact**: Hardcoded credentials pose security risk
...
### 9. Hardcoded API key
**Severity**: Major | **Confidence**: High
**Evidence**: `REVIEW/EMAIL-SCRAPER-REVIEW.md:113`
```
config.api_key = "te***"
```
**Impact**: Hardcoded credentials pose security risk
...
- **Hardcoded API key** (Major)
  - Location: `EXAMPLE-REVIEW.md:83`
  - Fix: Use environment variables
- **Hardcoded API key** (Major)
  - Location: `EXAMPLE-REVIEW.md:92`
  - Fix: Use environment variables
- **Hardcoded API key** (Major)
  - Location: `REVIEW/BRANCH-REVIEW.md:78`
  - Fix: Use environment variables
- **Hardcoded API key** (Major)
  - Location: `REVIEW/BRANCH-REVIEW.md:87`
  - Fix: Use environment variables
- **Hardcoded API key** (Major)
  - Location: `REVIEW/EMAIL-SCRAPER-REVIEW.md:86`
  - Fix: Use environment variables
- **Hardcoded API key** (Major)
  - Location: `REVIEW/EMAIL-SCRAPER-REVIEW.md:95`
  - Fix: Use environment variables
- **Hardcoded API key** (Major)
  - Location: `REVIEW/EMAIL-SCRAPER-REVIEW.md:104`
  - Fix: Use environment variables
- **Hardcoded API key** (Major)
  - Location: `REVIEW/EMAIL-SCRAPER-REVIEW.md:113`
  - Fix: Use environment variables
- **Hardcoded API key** (Major)
...
### Observability
**Issues Found:**
- Missing logging in business logic in `EXAMPLE-CODEMAP.md`
- Missing logging in business logic in `README.md`
- Missing logging in business logic in `REVIEW/CODEMAP.md`
...
- **Reading entire file into memory** (Minor)
  ...
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:34`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:58`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:178`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:202`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:226`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:250`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:274`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:298`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:322`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:826`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:850`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:874`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:898`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:922`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:946`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:970`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:994`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:1018`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:1042`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:1066`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:1090`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:1114`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:1138`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:2938`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:3562`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:3586`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:6394`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `EXAMPLE-FINDINGS.json:6418`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/BRANCH-FINDINGS.json:34`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/BRANCH-FINDINGS.json:58`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/BRANCH-FINDINGS.json:1402`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/BRANCH-FINDINGS.json:2002`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/BRANCH-FINDINGS.json:2026`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/BRANCH-FINDINGS.json:4762`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/BRANCH-FINDINGS.json:4786`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:58`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:82`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:346`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:370`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:394`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:418`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:442`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:466`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:490`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:3058`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:3658`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:3682`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:6490`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
- **Reading entire file into memory** (Minor)
  - Location: `REVIEW/EMAIL-SCRAPER-FINDINGS.json:6514`
  - Impact: Large file operations may cause memory issues
  - Fix: Use streaming/chunked reading
...
**Build-related files:**
- `requirements.txt` (Source module)
...
|------|------|-----|-------------|-------|-------------|---------|
| AUDIT_SYSTEM_README.md | Markdown | 205 | unknown (unknown) | 117b18ecdfc3 | - | Documentation |
...
| EXAMPLE-CODEMAP.md | Markdown | 266 | unknown (unknown) | 757b0ee4547f | - | Documentation |
| EXAMPLE-FINDINGS.json | JSON | 6458 | unknown (unknown) | e00e14498290 | - | Source module |
| EXAMPLE-REVIEW.md | Markdown | 958 | unknown (unknown) | c2aa6352e15e | - | Documentation |
| README.md | Markdown | 103 | 76688fb (22.08.2025) | 8c53a27015dc | - | Documentation |
| REVIEW/BRANCH-FINDINGS.json | JSON | 4826 | unknown (unknown) | 14ec5fb98144 | - | Source module |
| REVIEW/BRANCH-REVIEW.md | Markdown | 865 | unknown (unknown) | 76369b5fe823 | - | Documentation |
| REVIEW/CODEMAP.md | Markdown | 243 | unknown (unknown) | 3357798367c5 | - | Documentation |
| REVIEW/EMAIL-SCRAPER-CODEMAP.md | Markdown | 286 | unknown (unknown) | a967a6238c0e | - | Documentation |
| REVIEW/EMAIL-SCRAPER-FINDINGS.json | JSON | 6554 | unknown (unknown) | a54b6d2b7930 | - | Source module |
| REVIEW/EMAIL-SCRAPER-REVIEW.md | Markdown | 920 | unknown (unknown) | 2a9e0a4589a2 | - | Documentation |
...
| requirements.txt | Unknown | 11 | 76688fb (22.08.2025) | d14380688ffa | - | Source module |
...
**Coverage**: 53 files analyzed (100% of in-scope files)
