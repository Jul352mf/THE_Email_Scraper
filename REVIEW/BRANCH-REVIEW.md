...
- **Scale**: 39 files, 9,582 lines of code
- **Languages**: Python
- **Critical Issues**: 0 found
- **Major Issues**: 58 found
...
**Severity**: Major | **Confidence**: Med
**Evidence**: `archive/rate_limiter.py:63`
```
...
| audit_system/config.py | Python | 80 | unknown (unknown) | 3e0f35971c8b | RuntimeActions, OutputPaths, AuditConfig | Configuration |
...
**Coverage**: 39 files analyzed (100% of in-scope files)
