...
- The assistant will create a feature branch `task/<id>-short-desc`, implement, add a small test or smoke check, run quick validation, commit, push and open a PR (if requested).
...
- Branch: `task/TASK-001-tokenbucket-fix`
...
- Edge cases: extremely low rate_per_sec, concurrent callers, capacity refill accuracy.
...
- Commit message: `fix(http): avoid holding TokenBucket lock while sleeping (concurrency)`
 - Result: Implemented and merged on commit 9c731f7; added `tests/test_tokenbucket.py` verifying concurrent consumers complete within bounds.

### TASK-002 — Preserve rotating User-Agent (HIGH) [Done]

- Branch: `task/TASK-002-ua-headers`
- Files: `scraper/http.py`
...
### TASK-003 — Fix crawler default workers (MEDIUM) [Open]
- Branch: `task/TASK-003-crawler-workers`
...
- Branch: `task/TASK-004-orchestrator-reset`
...
- Branch: `task/TASK-005-browser-fallback`
...
- Branch: `task/TASK-007-skip-google`
...
- Branch: `task/TASK-008-extractor-cleanup`
...
- Branch: `task/TASK-011-lint-precommit`
...
- Branch: `task/TASK-012-packaging-entrypoints`
...
- Branch: `task/TASK-014-secrets-ci-env`
...
- Branch: `task/TASK-015-sitemap-threadpool`
...
- Branch: `task/TASK-016-extractor-cache`
...
- Branch: `task/TASK-017-canon-tests`
...
- Branch: `task/TASK-018-google-ratelimit`
...
- Branch: `task/TASK-019-dev-setup`
...
- Branch: `task/TASK-020-worker-sizing`
...
- Branch: `task/TASK-021-session-reuse`
- Files: `scraper/http.py`
...
- Branch: `task/TASK-022-parse-sanitize`
...
- Branch: `task/TASK-023-async-prototype`
...
- Branch: `task/TASK-026-docs-config-examples`
...
- When you ask the assistant to start a task, it will set `Status: In Progress`, create the branch, and update this file.
- When done, assistant will set `Status: Done` and include a short summary and PR/commit details.

---

## Notes
- Keep changes small and test-driven. We will implement one task per branch and smoke test before merging.
- Use the backup branch `main-backup-YYYYMMDD_HHMMSS` (already created earlier) if you need to restore previous `main`.

---

Last updated: 2025-08-22 (TASK-002 done)
